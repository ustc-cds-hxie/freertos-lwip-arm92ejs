...
void startupTask(void* pvParameters)
{
    ...
    vDirectPrintMsg("--- startupTask starting! ---\n");
    ...
    ** Create the RAM disk
    */
    vDirectPrintMsg("Creating RAM Disk\n");
    CreateRamDisk();
       ...
       ** Test the RAM disk
       */
       vDirectPrintMsg("Testing the RAM Disk\n");
       vCreateAndVerifyExampleFiles("/ram");
    #endif

    vDirectPrintMsg("Get directory for /ram - before untar\n");
    ListFATDir("/ram");
    ...
    */
    ...
    vDirectPrintMsg("Caling Untar_FromMemory\n"); 
    ...
    vDirectPrintMsg("Get directory for /ram after untar\n");
    ListFATDir("/ram");

    vDirectPrintMsg("Get directory for /ram/rootfs/cf after untar\n");
    ...
    */
    vDirectPrintMsg("Creating task1-3\n");
    ...
    vDirectPrintMsg("Creating task10\n");
    ...
    vDirectPrintMsg(" --- startupTask jobs complete - exiting task\n");
    vTaskDelete(NULL);
